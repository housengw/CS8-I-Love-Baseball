    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    // Connects
    connect(ui->mouse_area, SIGNAL(Mouse_Pos()), this,
            SLOT(Mouse_current_pos()));
    connect(ui->mouse_area, SIGNAL(Mouse_Release()), this,
            SLOT(Mouse_release()));
}
...
void MainWindow::on_Map_clicked()
{
    ...
    m = m.scaled(ui->graphicsView->width(), ui->graphicsView->height(),
...
{
    //
    ui->current_pos->setText(QString("X = %1, Y = %2")
                                 .arg(ui->mouse_area->y)
                                 .arg(ui->mouse_area->y));
}
...
{
    ui->location_pressed->setText(QString("X = %1, Y = %2")
                                      .arg(ui->mouse_area->y)
                                      .arg(ui->mouse_area->y));
}
